...
PRODUCT_COPY_FILES := \
 ...
 $(LOCAL_PATH)/proprietary/etc/firmware/nvddk_audiofx_core.axf:system/etc/firmware/nvddk_audiofx_core.axf \
 $(LOCAL_PATH)/proprietary/etc/firmware/nvddk_audiofx_transport.axf:system/etc/firmware/nvddk_audiofx_transport.axf \
 ...
 $(LOCAL_PATH)/proprietary/etc/firmware/nvmm_audiomixer.axf:system/etc/firmware/nvmm_audiomixer.axf \
 ...
 $(LOCAL_PATH)/proprietary/etc/firmware/nvmm_mp2dec.axf:system/etc/firmware/nvmm_mp2dec.axf \
 ...
 $(LOCAL_PATH)/proprietary/etc/firmware/nvmm_sw_mp3dec.axf:system/etc/firmware/nvmm_sw_mp3dec.axf \
 ...
 $(LOCAL_PATH)/proprietary/lib/libnvddk_audiofx.so:system/lib/libnvddk_audiofx.so \
 $(LOCAL_PATH)/proprietary/lib/libnvdispatch_helper.so:system/lib/libnvdispatch_helper.so \
 ...
 $(LOCAL_PATH)/proprietary/lib/libnvrm_channel.so:system/lib/libnvrm_channel.so \
